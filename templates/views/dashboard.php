            ...
            <div class="bg-white rounded">
                ...
                <form method="post" class="p-4">
                    <div class="mb-4">
                        ...
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="lastname" type="text" value="<?= $auth->getLastname() ?>" placeholder="Doe">
                    </div>
                    <div class="mb-4">
                        <label class="block text-grey-darker text-sm font-bold mb-2" for="firstname">
                            Prénom
                        </label>
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="firstname" type="text" value="<?= $auth->getFirstname() ?>" placeholder="John">
                    </div>
                    <div class="mb-4">
                        <label class="block text-grey-darker text-sm font-bold mb-2" for="email">
                            Email
                        </label>
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="email" type="text" value="<?= $auth->getEmail() ?>" placeholder="email@domaine.fr">
                    </div>
            ...
            <div class="bg-white rounded mt-10">
                ...
                <form method="post" class="p-4">
                    <div class="mb-6">
                        ...
                        <input class="shadow appearance-none border border-red rounded w-full py-2 px-3 text-grey-darker" id="previous_password" type="password" placeholder="******************">
                    </div>
                    <div class="mb-6">
                        <label class="block text-grey-darker text-sm font-bold mb-2" for="new_password">
                            Nouveau mot de passe
                        </label>
                        <input class="shadow appearance-none border border-red rounded w-full py-2 px-3 text-grey-darker mb-3" id="new_password" type="password" placeholder="Nouveau mot de passe">
                    </div>
                    <div class="mb-6">
                        <label class="block text-grey-darker text-sm font-bold mb-2" for="password_confirm">
                            Confirmation du mot de passe
                        </label>
                        <input class="shadow appearance-none border border-red rounded w-full py-2 px-3 text-grey-darker mb-3" id="password_confirm" type="password" placeholder="Confirmez votre nouveau mot de passe">
                    </div>
                    <div class="flex items-center justify-between">
                        <button class="bg-blue-700 rounded border-2 border-blue-800 p-2 text-white text-semi-bold hover:underline hover:bg-blue-600">
                            Modifier
