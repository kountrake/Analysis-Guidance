<div class="w-full">
    ...
    <div class="w-full px-8 h-screen">
        <div class="mt-10 mx-2 w-full h-1/2 mb-20">
            <div class="bg-white rounded float-left w-5/12">
                ...
                <form method="post" class="p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input name ="entantque" class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="entantque" type="text">
                    </div>
                    <div class="mb-4">
                        <label class="block text-grey-darker text-sm font-bold mb-2" for="jeveux">
                            Je veux :
                        </label>
                        <input name="jeveux" class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="jeveux" type="text">
                    </div>
                    <div class="mb-4">
                        <label class="block text-grey-darker text-sm font-bold mb-2" for="desorte">
                            De sorte que :
                        </label>
                        <input name="desorte" class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="desorte" type="text">
                    </div>
            ...
            <div class="bg-white rounded mt-10 float-right w-5/12">
                ...
                <form method="post" class="p-4">
                    <div class="mb-6">
                        ...
                        <input name="satisfait" class="shadow appearance-none border border-red rounded w-full py-2 px-3 text-grey-darker" id="satisfait" type="text">
                    </div>
            ...
            <button type='submit' class="bg-blue-700 rounded border-2 border-blue-800 p-2 text-white text-semi-bold hover:underline hover:bg-blue-600 relative top-full left-16">
                            Générer
            </button>
        </div>
